...
namespace FactoryDesignPattern
{
    ...
    {
        public void GetProduct(string product,string productOperations, string databaseOperation)
        {
            IRepository repository = RepositoryFactory.GetRepository(databaseOperation);
            ...
            method.Invoke(classObj,new object[] { repository});
        }
    }
}
